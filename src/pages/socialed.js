  ...
  <Layout>
    ...
    <main className="project">
      ...
      <section className="project__description">
        ...
        <p>
        Socialed is a socializing app that brings people together to do an activity (bowling, coffee, etc.) which bonds people for effective interaction of ideas, emotions, experiences in groups or person without the use of messenger technology. It is targeted for users ages between 18-45 who maybe students & working professionals. Socialed uniqueness is that it is designed specifically for people who want to find another people/group for socializing in person.
        </p>
        <h2>Problem</h2>
